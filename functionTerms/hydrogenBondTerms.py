...
def beta_term_1(oa, k_beta=1*kilocalories_per_mole, periodic=False, forceGroup=27):
    print("beta_1 term ON")
...
def beta_term_2(oa, k_beta=1*kilocalories_per_mole, periodic=False, forceGroup=27):
...
def beta_term_3(oa, k_beta=1*kilocalories_per_mole, periodic=False, forceGroup=27):
...
def pap_term_1(oa, k_pap=1*kilocalories_per_mole, dis_i_to_i4=1.2, forceGroup=28, ssweightFileName="ssweight", periodic=False):
    print("pap_1 term ON")
...
def pap_term_2(oa, k_pap=1*kilocalories_per_mole, dis_i_to_i4=1.2, forceGroup=28, ssweightFileName="ssweight", periodic=False):
    print("pap_2 term ON")
    k_pap = convert_units(k_pap) * oa.k_awsem
    nres, ca = oa.nres, oa.ca
    # r0 = 2.0 # nm
