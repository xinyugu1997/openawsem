...
from functionTerms.amhgochainTerm import *
from functionTerms.PCAanimationTerms import *
from functionTerms.RibbonTerms import *
from functionTerms.C_rg import *
from functionTerms.ER_pairs import *
from functionTerms.Bias_contact import *
from functionTerms.constraints import *
from functionTerms.NB_debyeHuckelTerms import *
from functionTerms.qBiasTerms_PBC import *
from functionTerms.AM_contactTerms import *
from functionTerms.AM_hydrogenBondTerms import *
...
def prepare_pdb(pdb_filename, chains_to_simulate, use_cis_proline=False, keepIds=False, removeHeterogens=True):
    ...
    for line in open(cleaned_pdb_filename):
        ...
        # res#1 or PRO should not has H.
        if (res_type == "PRO") or (int(res_index) == terminal_residues[chain][0]):
...
class OpenMMAWSEMSystem:
    def __init__(self, pdb_filename, chains='A', xml_filename='awsem.xml', k_awsem=1.0, seqFromPdb=None, seqFromFasta=None, includeLigands=False):
        # read PDB
        ...
        if seqFromPdb is None:
            self.seq = getSeq(pdb_filename, chains=chains, fromFasta=seqFromFasta)
        else:
            self.seq = seqFromPdb
        # elif seqFromPdb == 0:
