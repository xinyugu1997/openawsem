...
def contact_term(oa, k_contact=4.184, min_seq=10, z_dependent=False, z_m=1.5, inMembrane=False, membrane_center=0*angstrom, k_relative_mem=1.0, periodic=False, parametersLocation=".", burialPartOn=True, withExclusion=True, forceGroup=22,
    ...
    eta_sigma = 7.0
    rho_0 = 2.6
    min_sequence_separation = min_seq  # means j-i > 9
    min_sequence_separation_mem = min_seq 
    nwell = 2
    eta_switching = 10
