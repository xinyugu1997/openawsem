...
def beta_term_1(oa, k=1*kilocalories_per_mole, forceGroup=27):
    print("beta_1 term ON")
...
def beta_term_2(oa, k=1*kilocalories_per_mole, forceGroup=27):
...
def beta_term_3(oa, k=1*kilocalories_per_mole, forceGroup=27):
...
def pap_term_1(oa, k=1*kilocalories_per_mole, dis_i_to_i4=1.2, forceGroup=28, ssweightFileName="ssweight"):
    print("pap_1 term ON")
...
def pap_term_2(oa, k=1*kilocalories_per_mole, dis_i_to_i4=1.2, forceGroup=28, ssweightFileName="ssweight"):
    print("pap_2 term ON")
    k_pap = convert_units(k) * oa.k_awsem
    nres, ca = oa.nres, oa.ca
    # r0 = 2.0 # nm
